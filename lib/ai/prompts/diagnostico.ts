 ...
 *
 * Quando não há trilhas disponíveis, gera só a mensagem motivacional e as
 * habilidades prioritárias; caso contrário, pede também as trilhas recomendadas
 * em ordem de prioridade.
 *
 * O texto é mantido idêntico ao que estava inline na rota (Fase 1). Ajustes de
 * tom e personalização (nome, série, progresso) ficam para a Fase 2.
 */
